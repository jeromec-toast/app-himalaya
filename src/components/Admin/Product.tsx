    ...
    return (
        <>
            <div className="max-w-4xl mx-auto font-[sans-serif] text-[#333] p-6">
                <h2 className="text-xl text-gray-800 font-bold">Product Management</h2>
                ...
                <form className="mt-8 grid sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label className="text-gray-800 text-sm block mb-2">Code</label>
                    ...
                    <div>
                        <label className="text-gray-800 text-sm block mb-2">Pack Per Qty</label>
                        <input type='number' placeholder='Enter pack per quantity'
                            className="w-full rounded-md py-2.5 px-4 border border-gray-300 text-sm outline-[#007bff]" />
                    </div>
                    <div>
                        <label className="text-gray-800 text-sm block mb-2">MRP Price</label>
                    ...
                    <div>
                        <label className="text-gray-800 text-sm block mb-2">Stock</label>
                        <input type='number' placeholder='Enter stock'
                            className="w-full rounded-md py-2.5 px-4 border border-gray-300 text-sm outline-[#007bff]" />
                    </div>
                    <div>
                        <label className="text-gray-800 text-sm block mb-2">Rating</label>
                    ...
                    <div>
                        <label className="text-gray-800 text-sm block mb-2">Overview</label>
                        <input type='text' placeholder='Enter overview'
                            className="w-full rounded-md py-2.5 px-4 border border-gray-300 text-sm outline-[#007bff]" />
                    </div>
                    <div className="col-span-full">
                        <label className="text-gray-800 text-sm block mb-2">Full Description</label>
                        <textarea placeholder='Enter description'
                            className="w-full rounded-md py-8 px-4 border border-gray-300 text-sm pt-3 outline-[#007bff]"></textarea>
                    </div>
                    <div>
                        <label className="text-gray-800 text-sm block mb-2">In Stock</label>
                        <input id="chkStock" type="checkbox" className="w-4 h-4 mr-3 shrink-0" />
                    </div>
                    <div>
                        <label className="text-gray-800 text-sm block mb-2">Active</label>
                        <input id="chkActive" type="checkbox" className="w-4 h-4 mr-3 shrink-0" />
                    </div>
                    <div>
