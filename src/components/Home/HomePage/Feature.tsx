                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-10 mt-14">
                        <div>
                            ...
                            <Link to=";" className="text-blue-600 font-semibold inline-block mt-2 hover:underline">Learn
                                more</Link>
                        </div>
                        <div>
                        ...
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 fill-blue-600 mb-4 inline-block"
                                ...
                                <g fill="none" className="stroke-blue-600" stroke-miterlimit="10" stroke-width="30"
                                    transform="matrix(1.33 0 0 -1.33 0 682.667)">
                                    <path
